...
public class vuelo {
	...
	public vuelo(Integer id, Integer numero, String origen, LocalDateTime fecha_hora,
			com.example.models.ciudades ciudades, com.example.models.piloto piloto,
			com.example.models.tripulacion tripulacion, com.example.models.avion avion) {
		super();
		this.id = id;
		this.numero = numero;
		this.origen = origen;
